...
{
	static int page = 0;
	static LABEL* lbl1=NULL;
	static TEXTBUTTON* btn_dodge=NULL;
	static TEXTBUTTON* btn_mine=NULL;
	static TEXTBUTTON* btn_quit=NULL;
	static Dodge* dot = NULL;
	static MineSerch* mine = NULL;
	...
	case WM_LBUTTONUP:
		...
		{
			page = 1;
			PostMessage(hWnd, WM_SeenChange, wParam, 0);
		}
...
// ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡPAINT, COMMAND, DESTROYㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
	case WM_CREATE:
	{
		...
		btn_mine = new TEXTBUTTON(L"Mine Search", 1, 250, 220, 200, 50, 30);
